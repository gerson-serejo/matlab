...
%4) Results ---------------------------------------------------------------
subplot(2,2,1); imhist(MaxG); title(['Value of Otsu Method: (' num2str(ValueThreshold*TotalNumberPixels),'/',num2str(TotalNumberPixels), ') = ',num2str(ValueThreshold)]);
subplot(2,2,2); imshow(imBinarized); title('binary Image (MaxG OTSU)');
